    ...
    <>
      ...
      <section className="grid grid-cols-1 lg:grid-cols-[2fr_1fr] gap-4 mb-4 mt-10">
        ...
        <div className="h-[30rem] rounded-3xl p-10 flex flex-col gap-16 bg-[url('/gradient-bg.jpg')] bg-cover">
          <h1 className=' text-4xl font-semibold'> Hello, I&apos;m <span className=' text-purple-600 font-bold'>Taszid Izaz </span> a Creative Developer with 2 Years of Experience. </h1>

          <p className='flex-1'>
            I care a lot about creating design for positive impact and enjoy creating user-centric, deslightful and humane applications.
          </p>
